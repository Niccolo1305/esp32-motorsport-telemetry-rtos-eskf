// bmi270_config.h — BMI270 initialization config file (8192-byte binary blob)
//
// Source: https://github.com/boschsensortec/BMI270-Sensor-API
//         File: bmi270.c, array: bmi270_config_file[]
//
// The BMI270 REQUIRES this config file to be uploaded via burst write to
// INIT_DATA (0x5E) before the sensor becomes operational.
// Without this upload, the sensor will NOT produce valid data.
//
// License: Bosch Sensortec GmbH — BSD-3-Clause
//          See https://github.com/boschsensortec/BMI270-Sensor-API/blob/master/LICENSE
#pragma once

#include <stdint.h>
#include <pgmspace.h>

// Size of the BMI270 config file in bytes
static constexpr uint16_t BMI270_CONFIG_SIZE = 8192;
...
// Actual size of the embedded blob (for upload loop)
static constexpr uint16_t bmi270_config_actual_size = sizeof(bmi270_config_file);
